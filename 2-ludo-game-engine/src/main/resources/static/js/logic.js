...
var step_sound = new Audio('/audio/step.mp3');
var dead_sound = new Audio('/audio/dead.mp3');
var inout_sound = new Audio('/audio/inout.mp3');
var dice_sound = new Audio('/audio/dice.mp3');
var winner_sound = new Audio('/audio/winner.mp3');
        ...
        for (const item of run_point) {
            ...
            if (M_Player.path[M_Player.current_position] == 'win') {
                ...
                if (getWinPlayers(M_Player.home) > 3) {
                    ...
                    $(M_Player.home + " .white-box").css("background-image", "url(/images/crown" + rank_count + ".png)");
...
function activateDice() {
    ...
    $("#dice").html("<img src='/images/dice" + dice_value + ".png' class='dice'/>");
